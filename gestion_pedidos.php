...
<body>
    ...
    <div class="form-container">
        <h1>Dar de Alta Pedidos</h1>
        <form action="guardar_pedido.php" method="POST">
            Nombre del Proveedor: <input type="text" name="nombre_cliente" required><br>
            Descripción del Pedido: <textarea name="descripcion_pedido"></textarea><br>
            Fecha del Pedido: <input type="date" name="fecha_pedido" required><br>
